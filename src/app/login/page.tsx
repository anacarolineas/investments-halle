        ...
        <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
            ...
            <div className="p-5">
                <div className="grid grid-cols-3 gap-1">
                    ...
                    <button onClick={() => signIn("github")} type="button" className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Github</button>
                </div>
            </div>
                <div className="py-5">
